...
<div class="grid-wrap">
    ...
    <div class="item item-b">
        <div class="menu">
            <h3>Browse</h3>
            <ul>
                <li><a href="/discover" class="active"><i class="large material-icons">explore</i><span>Discover</span></a>
                </li>
    ...
    <div id="display-backdrop" class="item item-d">
        ...
        <div class="collection-poster">
            <a id="display-collection-link" href="#">
                <img id="display-collection-poster" class="z-depth-4" src="" alt="">
            </a>
        </div>
...
<div id="watch-trailer" class="modal">
    <a href="#!" class="modal-close"><i class="material-icons">close</i></a>
    <div class="modal-content">
        <iframe id="watch-trailer-iframe" width="560" height="315" src frameborder="0" allow="autoplay; encrypted-media"
