...
theMovieDb.common = {
  api_key: "823ef671efdada0a224c05f87e60a516",
  base_uri: "https://api.themoviedb.org/3/",
  images_uri: "https://image.tmdb.org/t/p/",
  timeout: 5000,
  language: "en-US",
  image_language: "en,null",
  generateQuery: function(options) {
    'use strict';
    var myOptions, query, option;

    myOptions = options || {};
    query = "?api_key=" + theMovieDb.common.api_key + "&language=" + theMovieDb.common.language + "&include_image_language=" + theMovieDb.common.image_language;
