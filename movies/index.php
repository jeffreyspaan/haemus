  ...
  <section class="title-container">
	...
	<section class="new-movie" >
		...
		<form method="post" id="new-movie-form" autocomplete="off">
			...
			<div class="row">
        <div class="input-field col s12">
          <textarea class="new-movie-excerpt materialize-textarea" id="new-movie-excerpt" name="excerpt"></textarea>
			...
			<div class=" nav-icon">
				<nav>
						<div class="nav-wrapper">
							...
							<a href="#" data-target="nav-mobile" class="button-collapse sidenav-trigger" style="position:fixed; top:0px;"><i class="mdi-navigation-menu material-icons">dehaze</i></a>
						</div>
				</nav>
			</div>
		</div>
