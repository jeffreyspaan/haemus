    ...
    <div class="grid-wrap">
      ...
      <div class="item item-b">
        <div class="menu">
          <h3>Browse</h3>
          <ul>
            <li><a href="/movies/staging/discover" class="active"><i class="material-icons">explore</i><span>Discover</span></a></li>
            <li><a href="/movies/staging/trending"><i class="material-icons">trending_up</i><span>Trending</span></a></li>
            <li><a href="/movies/staging/genres"><i class="material-icons">face</i><span>Genres</span></a></li>
